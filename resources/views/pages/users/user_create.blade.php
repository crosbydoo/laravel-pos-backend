    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">We provide to add new user.</p>
                <div class="card">
                    <form method="POST" action="{{ route('user.store') }}">
                        @csrf
                        <div class="card-header">
                            <h4>Fill User Form</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password" placeholder="Enter Password" class="form-control pwstrength @error('password') is-invalid
